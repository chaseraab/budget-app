package com.budget_app.service.allocation.budget;
...
@Service
public class AllocationBudgetService extends BaseService<AllocationBudget, Long, AllocationBudgetRequest, AllocationBudgetResponse> {

    private final AllocationBudgetMapper mapper;
    private final BudgetRepository budgetRepository;

    public AllocationBudgetService(AllocationBudgetRepository repository, AllocationBudgetMapper mapper, BudgetRepository budgetRepository) {
        super(repository);
        this.mapper = mapper;
